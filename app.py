...
st.markdown("""
Trabajo en la **empresa familiar vendiendo kekes** (con amor, claro 🍰), y además manejo la **imagen digital de una empresa en surgimiento**. Formo parte de **Empoderate.Pe**, una organización que impulsa el empoderamiento juvenil, en la comisión de comunicaciones con la finalidad de impulsar el pensamiento crítico y la comunicación con enfoque social.

Me encanta **grabar**, **tocar la guitarra** y perderme investigando cosas que me hacen pensar distinto. También, realizo **edición de videos musicales, videodocumentales, entrevistas y reels reflexivos**, adaptando el contenido visual y narrativo al gusto y necesidades del consumidor.  
